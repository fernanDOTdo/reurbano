...
class PublicationRepository extends BaseRepository
{
    ...
    /**
     * Retorna todos os banners ordenados pelo parÃ¢metro "order" e "name"
     *
     * @param string $id
     * @return bool
     */
    ...
    /**
     * Localiza uma publicação à partir area e a deal
     *
     * @param Area $area, area da publicação
     * @param Deal $deal, deal publicada nesta área
     *
     * @return bool
     */
    ...
    /**
     * Atualiza os cliques da publicação à partir area e a deal
     *
     * @param Area $area, area da publicação
     * @param Deal $deal, deal publicada nesta área
     */
